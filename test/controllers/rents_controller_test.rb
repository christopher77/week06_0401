...
class RentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rent" do
    assert_difference('Rent.count') do
      post rents_url, params: { rent: { cassette_id: @rent.cassette_id, member_id: @rent.member_id, rent_date: @rent.rent_date, return_date: @rent.return_date } }
    end
  ...
  test "should update rent" do
    patch rent_url(@rent), params: { rent: { cassette_id: @rent.cassette_id, member_id: @rent.member_id, rent_date: @rent.rent_date, return_date: @rent.return_date } }
